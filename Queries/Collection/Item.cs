...
public class Item
{
    ...
    [XmlAttribute(AttributeName = "subtype")] public SubType SubType { get; set; }
    [XmlAttribute(AttributeName = "collid")] public int CollId { get; set; }
    [XmlElement(ElementName = "yearpublished")] public int YearPublished { get; set; }
    ...
    [XmlElement(ElementName = "numplays")] public int NumPlays { get; set; }
