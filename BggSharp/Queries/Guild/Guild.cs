...
public class Guild
{
    ...
    [XmlAttribute(AttributeName = "created")] public string Created { get; set; }
    ...
    [XmlElement(ElementName = "manager")] public string Manager { get; set; }
    ...
    [XmlElement(ElementName = "members")] public MemberItems Members { get; set; }
}