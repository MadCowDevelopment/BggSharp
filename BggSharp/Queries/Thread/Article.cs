...
public class Article
{
    ...
    [XmlElement(ElementName = "body")] public string Body { get; set; }
    ...
    [XmlAttribute(AttributeName = "editdate")] public string EditDate { get; set; }
    [XmlAttribute(AttributeName = "numedits")] public int NumberOfEdits { get; set; }
}
